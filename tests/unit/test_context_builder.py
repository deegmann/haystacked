...
def test_build_system_context_excludes_user_description():
    """Regression test anchored to the 2026-07-30 lifting_height_mm hallucination:
    ...
    assert "lifting_height_mm [KO]" in ctx
...
def test_build_system_context_never_leaks_any_user_description():
    ...
    may appear in any domain's system prompt, not just lifting_height_mm's. Guards
