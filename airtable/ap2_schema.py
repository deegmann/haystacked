...
EXTENSIONS_FIELDS = [
    ...
    ss("infrastructure_free", ["True", "False"]),
    ...
    ss("multi_load_compatibility", ["True", "False"]),
    ...
    ss("vda5050_compatible", ["True", "False"]),
    ...
    ss("forks_free_floating", ["True", "False"]),
    ss("stacking_capability", ["True", "False"]),
    ms("load_detection", [
        "None", "Camera/Vision", "Laser/LiDAR profiling", "RFID",
        "Barcode/DataMatrix", "Mechanical/Tactile", "Predefined coordinates",
    ]),
    ss("barcode_readers", ["True", "False"]),
    check("stock_line_scanning"),
    ss("trailer_loading", ["True", "False"]),
    ss("trailer_unloading", ["True", "False"]),
    ...
    ss("rack_pin_compatible", ["True", "False"]),
    ss("free_lift_open_closed_pallet", ["True", "False"]),
